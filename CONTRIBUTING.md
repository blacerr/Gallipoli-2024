...
1. Projenin GitHub sayfasında [Issues](https://github.com/blacerr/Gallipoli-2024/issues) sekmesine gidin.
...
2. Kendi forkladığınız projeyi yerel bilgisayarınıza klonlayın:
    ```bash
    git clone https://github.com/kendi-kullanici-adiniz/Gallipoli-2024.git
    ```
